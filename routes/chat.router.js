...
import {CreateChat, UpdateChat, SendMessage, SendMediaMessage, 
    GetMessages, GetChatsList, TestPusher, ReadAllMessages} from "../controllers/chat.controller.js";
...
chatRouter.post("/read_all", verifyJwtToken, ReadAllMessages);
